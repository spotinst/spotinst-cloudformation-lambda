...
let destroy = async function(err, event, context) {
  ...
  // spotUtil.parseBoolean(deletePolicy.shouldForceDelete)
  
  //let shouldDeleteImages            =
  // spotUtil.parseBoolean(deletePolicy.shouldDeleteImages); let
  // shouldDeleteNetworkInterfaces =
  // spotUtil.parseBoolean(deletePolicy.shouldDeleteNetworkInterfaces); let
  // shouldDeleteVolumes           =
  // spotUtil.parseBoolean(deletePolicy.shouldDeleteVolumes); let
  // shouldDeleteSnapshots         =
  // spotUtil.parseBoolean(deletePolicy.shouldDeleteSnapshots);
