...
var destroy = function(err, event, context) {
  ...
  spotUtil.getToken(event, function(err, token) {
    ...
    var deletePolicy = getDeletePolicyConfig(event) || {};
    
    var shouldDeleteImages            = spotUtil.parseBoolean(deletePolicy.shouldDeleteImages);
    var shouldDeleteNetworkInterfaces = spotUtil.parseBoolean(deletePolicy.shouldDeleteNetworkInterfaces);
    var shouldDeleteVolumes           = spotUtil.parseBoolean(deletePolicy.shouldDeleteVolumes);
    var shouldDeleteSnapshots         = spotUtil.parseBoolean(deletePolicy.shouldDeleteSnapshots);
