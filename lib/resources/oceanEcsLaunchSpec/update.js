...
function update(err, event, context) {
  ...
  spotUtil.getTokenAndConfig(event, function (err, tc) {
    ...
    console.log('Update ocean ECS launchSpec: ' + JSON.stringify(oceanUpdateConfig, null, 2))
    ...
    request(updateOceanOptions, function (err, res, body) {
      spotUtil.validateResponse({
        ...
        successCb: function (spotResponse) {
          console.log('Ocean ECS Launch Spec Update Success: ' + JSON.stringify(body, null, 2));
