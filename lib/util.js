...
function getTokenRequestOptions(config = {}) {
  let options = {
    method:  "POST",
...
/**
 * This function will call the asgOperation Scale Once if the asgOperation is found in the CF template, other wise a
 * regular update will commence
 *
 * @function
 * @name asgOperation
 *
 ...
 * @name generateTags
 *
 * @param {Object} obj - Contains {event: event, context: context, updatePolicy: updatePolicy, refId: refId, token:
 *   tc.token, body: updatePolicy.rollConfig}
 */
