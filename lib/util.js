...
module.exports.updateGroup = function(obj) {
  ...
  let updateOptions = {
    ...
    qs:      {
      accountId:            module.exports.getSpotinstAccountId(obj.objevent),
      shouldResumeStateful: obj.updatePolicy.shouldResumeStateful
    },
    headers: {
      'Content-Type' : 'application/json',
      'Authorization': 'Bearer ' + obj.tc.token,
      'User-Agent'   : module.exports.getUserAgent()
    },
    json:    {
      group: obj.body
  ...
  console.log('Update Policy config: ' + JSON.stringify(obj.updatePolicy, null, 2));
