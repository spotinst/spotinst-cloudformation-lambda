...
const RESOURCES = ['group', 'subscription', 'healthCheck','beanstalkElastigroup'];
...
var parseBoolean = module.exports.parseBoolean = function(str) {
  let retVal;
...
var getSpotinstAccountId = module.exports.getSpotinstAccountId = function(event) {
