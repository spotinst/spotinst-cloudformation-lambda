  ...
  request(getGroupOptions, function(err, res, body) {
    module.exports.validateResponse({
      ...
      successCb: function(spotResponse) {
        ...
        util.done(new Error("Validate Failed"), event, context);
      },
 ...
 * @property {String} asg name string 
 */
module.exports.destroy = function(err, event, context) {
  if(err) {
    return util.done(err);
  }
  
  module.exports.getToken(event, function(err, token) {
    ...
    let deletePolicy = module.exports.getDeletePolicyConfig(event) || {}

    let rollbackToAsg     = module.exports.parseBoolean(deletePolicy.rollbackToAsg)
    let shouldForceDelete = module.exports.parseBoolean(deletePolicy.shouldForceDelete)

    let shouldDeleteImages            = module.exports.parseBoolean(deletePolicy.shouldDeleteImages);
    let shouldDeleteNetworkInterfaces = module.exports.parseBoolean(deletePolicy.shouldDeleteNetworkInterfaces);
    let shouldDeleteVolumes           = module.exports.parseBoolean(deletePolicy.shouldDeleteVolumes);
    let shouldDeleteSnapshots         = module.exports.parseBoolean(deletePolicy.shouldDeleteSnapshots);    
    ...
    request(deleteOptions, function(err, res, body) {
      module.exports.validateResponse({
        ...
        failureCb: function(spotResponse) {
          ...
          module.exports.validateGroup(refId, token, event, context);
        }
      });
    });
