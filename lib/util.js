...
module.exports.getUpdatePolicyConfig = function (event) {
  return _.get(event, 'ResourceProperties.updatePolicy') || _.get(event, 'updatePolicy');
}

/**
 * This function gets the delete policy from the CF template
 *
 * @function
 * @name generateTags
 *
...
module.exports.getDeletePolicyConfig = function (event) {
  return _.get(event, 'ResourceProperties.deletePolicy') || _.get(event, 'deletePolicy');
}
 ...
 *
 * @param {String} clusterId - Ocean Cluster ID
 * @param {String} token - Spotinst API Token
 * @param {Object} event - Event data from Lambda
 * @param {Object} context - Context data from Lambda
 *
 ...
 * @name validateOceanCluster
 *
 * @param {String} statefulNodeId - Stateful Node ID
 * @param {String} token - Spotinst API Token
 * @param {Object} event - Event data from Lambda
 * @param {Object} context - Context data from Lambda
 *
 * @property {String} asg name string
 */
module.exports.validateStatefulNode = function (statefulNodeId, token, event, context) {
  var getStatefulNodeOptions = {
    method:  'GET',
    url:     'https://api.spotinst.io/aws/ec2/managedInstance/' + statefulNodeId,
    qs:      {
      accountId: module.exports.getAccountId(event)
    },
    headers: {
  ...
  request(getStatefulNodeOptions, function (err, res, body) {
    module.exports.validateResponse({
      err:       err,
      res:       res,
      body:      body,
      ...
      context:   context,
      successCb: function (spotResponse) {
        console.log("stateful node does exist, fail the delete.");
        // Return failed to delete (cause the stateful node does exist)
        util.done("validate failed", event, context);
      },
      failureCb: function () {
        // if the stateful node doesn't exist, we can count the delete as success
        if (res.statusCode === 404 || res.statusCode === 400) {

          console.log("stateful node doesn't exist, set the delete as success.")
          try {
            body = JSON.parse(body);
          } catch (err) {
          }
          ...
          util.done("can't get stateful node", event, context);
        }
      }
    });
  });
...
/**
 * This function resumes the stateful node. Used in update
 *
 * @function
 * @name generateTags
 *
 ...
 *   updatePolicy: updatePolicy, refId: refId, tc: tc, body: body}
 */
module.exports.resumeStatefulNode = function (obj) {
  let rollOptions = {
    method:  'PUT',
    url:     'https://api.spotinst.io/aws/ec2/managedInstance/' + obj.refId + '/resume',
    qs:      {
      accountId: module.exports.getAccountId(obj.event)
    },
    headers: {
  ...
  console.log("resuming stateful node: " + JSON.stringify(rollOptions, null, 2))
  request(rollOptions, function (err, res, body) {
    module.exports.validateResponse({
      err:       err,
      res:       res,
...
/**
 * This function pauses the stateful node. Used in update
 *
 * @function
 * @name generateTags
 *
 ...
 *   updatePolicy: updatePolicy, refId: refId, tc: tc, body: body}
 */
module.exports.pauseStatefulNode = function (obj) {
  let rollOptions = {
    method:  'PUT',
    url:     'https://api.spotinst.io/aws/ec2/managedInstance/' + obj.refId + '/pause',
    qs:      {
      accountId: module.exports.getAccountId(obj.event)
    },
    headers: {
  ...
  console.log("pausing stateful node: " + JSON.stringify(rollOptions, null, 2))
  request(rollOptions, function (err, res, body) {
    module.exports.validateResponse({
      err:       err,
      res:       res,
...
/**
 * This function recycles the stateful node. Used in update
 *
 * @function
 * @name generateTags
 *
 ...
 *   updatePolicy: updatePolicy, refId: refId, tc: tc, body: body}
 */
module.exports.recycleStatefulNode = function (obj) {
  let rollOptions = {
    method:  'PUT',
    url:     'https://api.spotinst.io/aws/ec2/managedInstance/' + obj.refId + '/recycle',
    qs:      {
      accountId: module.exports.getAccountId(obj.event)
    },
    headers: {
  ...
  console.log("recycling stateful node: " + JSON.stringify(rollOptions, null, 2))
  request(rollOptions, function (err, res, body) {
    module.exports.validateResponse({
      err:       err,
      res:       res,
