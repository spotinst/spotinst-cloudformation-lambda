...
//     // it("fail to get mrScaler cluster from tags 1 time then success", function(done){
//     //   nock('https://api.spotinst.io', {"encodedQueryParams": true})
//     //     .get('/aws/emr/mrScaler')
//     //     .reply(200, {
//     //       "request":  {"id": "9bad8ebc-a42c-425f-83ab-fbec3b1cbd8a","url": "/aws/emr/mrScaler/simrs-85e26ac5","method": "GET","timestamp": "2016-01-28T17:34:37.072Z"},
//     //       "response":{"items":[{"compute":{"tags":[{"tagKey":"test", "tagValue":"fails"}]}}]}});
...
//     //   util.done = sandbox.spy((err, event, context, body)=>{
//     //     assert.equal(err, null)
//     //     assert.equal(body.response.status.code, 200)
//     //     done();
//     //   })

//     //   deleteGroup.handler({
//     //     accessToken: ACCESSTOKEN,
//     //     id:          'MrScaler Error 10',
//     //     autoTag:true,
